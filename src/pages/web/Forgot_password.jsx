      ...
      <div className='main border border-1 border-[red]'>
        <div className='forgot_outer'>
          <div className='forgot h-[100vh]'>
            ...
            <header className='w-[100%] border-b-2 border-[grey] flex items-center justify-center py-5 bg-[white] sticky top-0'>
              <div className='w-[72%]'>
              ...
              <div className='forgot_form w-[400px] border border-4 border-[white]'>
                <div className='lock_section  pt-[15px] pb-[10px] flex justify-center items-center flex-col'>
                  <div className='w-[110px] h-[110px] border border-2 border-[black] rounded-[50%] flex items-center justify-center'>
                    <GoLock className='text-[70px]' />
                  </div>
                </div>
                <div className='w-[100%] flex items-center justify-center '>
                  <p className='font-[500]'>Trouble logging in?</p>
                </div>

                <div className='text-center text-[14.5px] mt-[3px]'>
                  <p>Enter your email, phone, or username and we'll send you a link to get back into your account.</p>
                </div>

                <div className='forgot_input w-[100%]  flex justify-center my-[10px]'>
                  <input type="text" placeholder='Email, Phone or Username' className='w-[330px] px-[10px] h-[40px] rounded-[5px] outline-none' />
                </div>

                <div className='forgot_button w-[100%]  flex justify-center'>
                  <button className='w-[330px] bg-[#0094f1] text-[white] text-[14.5px] font-[550] rounded-[7px] py-[4px]'>Send login link</button>
                </div>

                <div className='w-[100%]  flex justify-center'>
                  <p className='text-[13.5px] font-[550] text-[#000000]'>Can't reset your password?</p>
                </div>
                ...
                <Link to={"/"}>
                  <div className='w-[100%] mt-[50px] flex items-center justify-center py-[10px] bg-[white] animate-pulse font-[650]' >
                    <p>Back to login</p>
                  </div>
                </Link>
