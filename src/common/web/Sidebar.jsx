...
import myprofile from "../../images/myimg.jpeg"
...
export function Sidebar() {
  return (
    <>
       <div className='home_sidebar w-[18%] h-[100vh] bg-[black] fixed'>
                        <div className='sidebar_logo text-[white] h-[100px] flex items-center pl-[18px] z-[9999] '>
                            <div className='icon_logo mt-[-7px]'>
                        ...
                        <div className='all_sidebar_option'>
                            <div className='home_option  h-[50px] mt-[7px] text-[white] flex items-center px-[10px]'>
                                <Link className='home_option_inner w-[100%]  h-[100%] rounded-[7px] hover:bg-[grey] pl-[8px] flex items-center'>
                                    ...
                                    <p className='content ml-[10px] font-[660]'>Home</p>
                                </Link>
                            </div>

                            <div className='search_option  h-[50px] mt-[7px] text-[white] flex items-center px-[10px]'>
                                <Link className='search_option_inner w-[100%]  h-[100%] rounded-[7px] hover:bg-[grey] pl-[8px] flex items-center'>
                                    ...
                                    <p className='content ml-[10px] font-[660]'>Search</p>
                                </Link>
                            </div>

                            <div className='explore_option  h-[50px] mt-[7px] text-[white] flex items-center px-[10px]'>
                                <Link className='explore_option_inner w-[100%]  h-[100%] rounded-[7px] hover:bg-[grey] pl-[8px] flex items-center'>
                                    ...
                                    <p className='content ml-[10px] font-[660]'>Explore</p>
                                </Link>
                            </div>

                            <div className='reels_option  h-[50px] mt-[7px] text-[white] flex items-center px-[10px]'>
                                <Link className='reels_option_inner w-[100%]  h-[100%] rounded-[7px] hover:bg-[grey] pl-[8px] flex items-center'>
                                    ...
                                    <p className='content ml-[10px] font-[660]'>Reels</p>
                                </Link>
                            </div>

                            <div className='messages_option  h-[50px] mt-[7px] text-[white] flex items-center px-[10px]'>
                                <Link className='messages_option_inner w-[100%]  h-[100%] rounded-[7px] hover:bg-[grey] pl-[8px] flex items-center'>
                                    ...
                                    <p className='content ml-[10px] font-[660]'>Messages</p>
                                </Link>
                            </div>

                            <div className='notification_option  h-[50px] mt-[7px] text-[white] flex items-center px-[10px]'>
                                <Link className='notification_option_inner w-[100%]  h-[100%] rounded-[7px] hover:bg-[grey] pl-[8px] flex items-center'>
                                    ...
                                    <p className='content ml-[10px] font-[660]'>Notifications</p>
                                </Link>
                            </div>

                            <div className='create_option  h-[50px] mt-[7px] text-[white] flex items-center px-[10px]'>
                                <Link className='create_option_inner w-[100%]  h-[100%] rounded-[7px] hover:bg-[grey] pl-[8px] flex items-center'>
                                    ...
                                    <p className='content ml-[10px] font-[660]'>Create</p>
                                </Link>
                            </div>

                            <div className='profile_option  h-[50px] mt-[7px] text-[white] flex items-center px-[10px]'>
                                
                                    <Link className='profile_option_inner w-[100%]  h-[100%] rounded-[7px] hover:bg-[grey] pl-[8px] flex items-center'>
                                        {/* <IoPersonCircleOutline className='text-[26px]'/> */}
                                        <div className='border border-1 border-[white] w-[25px] h-[25px] rounded-[50%] overflow-hidden'>
                                            <img src={myprofile} alt="" />
                                        </div>
                                        <p className='content ml-[10px] font-[660]'>Profile</p>
                                    </Link>
                                
                            </div>

                            <div className='more_option   h-[50px] mt-[7px] text-[white] flex items-center px-[10px]'>
                                <Link className='w-[100%]  h-[100%] rounded-[7px] hover:bg-[grey] pl-[8px] flex items-center'>    
                                        ...
                                        <p className='content ml-[10px] font-[660]'>More</p>
                                </Link>
                            </div>
